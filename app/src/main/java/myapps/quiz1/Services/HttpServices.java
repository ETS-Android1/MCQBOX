...
import myapps.quiz1.Activity.Main1Activity;
import myapps.quiz1.App.Config;
import myapps.quiz1.App.MyApplication;
...
public class HttpServices extends IntentService {
    ...
    private static String TAG = HttpServices.class.getSimpleName();

    public HttpServices() {
        super(HttpServices.class.getSimpleName());
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(HttpServices.this, Main1Activity.class);
