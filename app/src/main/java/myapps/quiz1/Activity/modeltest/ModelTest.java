...
import myapps.quiz1.Model.physics1;
...
public class ModelTest extends AppCompatActivity {
    ...
    private void getModeltest() {
        pDialog = ProgressDialog.show(ModelTest.this,"Loading...",
        ...
        Call<physics1_paper> call =  api.getModeltest();

        call.enqueue(new Callback<physics1_paper>() {
            @Override
            public void onResponse(Call<physics1_paper> call, Response<physics1_paper> response) {
                pDialog.dismiss();
                final ArrayList<physics1> physics1 = response.body().getModeltest();
               //qid=0;
                hero=physics1.get(qid);
                ...
                butNext.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                      ...
                      int size=  physics1.size();
                        if(qid<size) {


                            Log.d("yourans", "real=" + real);
                            Toast.makeText(ModelTest.this, " Ans is = " + real, Toast.LENGTH_LONG).show();
                            hero = physics1.get(qid);
                            setQuestionView();
                            if (real == user) {
                                ...
                                Toast.makeText(ModelTest.this, "Score is = " + score, Toast.LENGTH_LONG).show();
                                //Toast.makeText(ModelTest.this, " ans  = " + real, Toast.LENGTH_LONG).show();
                                //qid++;
                            }
                        }
                        else {

                            Intent myIntent = new Intent(ModelTest.this, ResultActivity.class);
            ...
            @Override
            public void onFailure(Call<physics1_paper> call, Throwable t) {
                pDialog.dismiss();
