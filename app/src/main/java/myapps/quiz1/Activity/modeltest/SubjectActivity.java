...
public class SubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subject_modeltest);
       ...
       // textView4 = (TextView) findViewById(R.id.grid_text4);
        ...
        textView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(SubjectActivity.this, MixedSubjectActivity.class);
        ...
        textView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(SubjectActivity.this, SingleSubjectActivity.class);
                startActivity(myIntent);
            }
        });
    }
