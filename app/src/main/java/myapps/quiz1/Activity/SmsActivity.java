...
import myapps.quiz1.Services.HttpServices;
...
public class SmsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pref.isLoggedIn()) {
            Intent intent = new Intent(SmsActivity.this, Main1Activity.class);
    ...
    private void verifyOtp() {
        ...
        if (!otp.isEmpty()) {
            Intent grapprIntent = new Intent(getApplicationContext(), HttpServices.class);
